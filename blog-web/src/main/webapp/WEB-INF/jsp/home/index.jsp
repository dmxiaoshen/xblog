...
<div id="ad-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="${ctx}/static/images/chrome-big.jpg" alt="1 slide" />
        ...
        <div class="item">
            <img src="${ctx}/static/images/firefox-big.jpg" alt="2 slide" />
        ...
        <div class="item">
            <img src="${ctx}/static/images/safari-big.jpg" alt="3 slide" />
        ...
        <div class="item">
            <img src="${ctx}/static/images/opera-big.jpg" alt="4 slide" />
        ...
        <div class="item">
            <img src="${ctx}/static/images/ie-big.jpg" alt="5 slide" />
...
<div class="container summary">
    ...
    <div class="row" id="summary-container">
        <div class="col-md-4">
            <img class="img-circle" src="${ctx}/static/images/chrome-logo-small.jpg" alt="chrome" />
        ...
        <div class="col-md-4">
            <img class="img-circle" src="${ctx}/static/images/firefox-logo-small.jpg" alt="firefox" />
        ...
        <div class="col-md-4">
            <img class="img-circle" src="${ctx}/static/images/safari-logo-small.jpg" alt="safari" />
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab-chrome">
            <div class="row feature">
                ...
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="${ctx}/static/images/chrome-logo.jpg"
                         alt="Chrome" />
                </div>
            </div>
        </div>
        <div class="tab-pane" id="tab-firefox">
            <div class="row feature">
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="${ctx}/static/images/firefox-logo.jpg"
                         alt="Firefox" />
                </div>
                <div class="col-md-7">
        ...
        <div class="tab-pane" id="tab-safari">
            <div class="row feature">
                ...
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="${ctx}/static/images/safari-logo.jpg"
                         alt="Safari" />
                </div>
            </div>
        </div>
        <div class="tab-pane" id="tab-opera">
            <div class="row feature">
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="${ctx}/static/images/opera-logo.jpg"
                         alt="Opera" />
                </div>
                <div class="col-md-7">
        ...
        <div class="tab-pane" id="tab-ie">
            <div class="row feature">
                ...
                <div class="col-md-5">
                    <img class="feature-image img-responsive" src="${ctx}/static/images/ie-logo.jpg"
                         alt="IE" />
                </div>
            </div>
        </div>
